...
const QUESTION_LIFECYCLE='js/questions/lifecycle.js?v=12.6.48';
...
async function bootstrapIndependentFeatures(){installNavigationGate();try{await loadScript(QUESTION_LIFECYCLE)}catch(e){console.error('AI-CLO question lifecycle module load failed',e)}try{await loadScript(AI_CLONE)}catch(e){console.error('AI-CLO AI clone module load failed',e)}}
