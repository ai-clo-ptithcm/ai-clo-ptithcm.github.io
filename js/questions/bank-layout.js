/* AI-CLO PTITHCM V12.6.31 — compact question-bank actions, filters and explicit selection mode. */
(()=>{
'use strict';
...
function compactMainActions(){
 ...
 if(generate){setTextIfNeeded(generate,'✦ AI sinh câu hỏi');generate.title='AI sinh câu hỏi';moveIfNeeded(generate,bar)}
